package com.reyhan.profileartis
...
import com.reyhan.profileartis.adapter.ArticleAdapter
...
class ListArtisFragment : Fragment() {
        ...
        recyclerView.adapter = ArticleAdapter(articles) { article ->
            ...
            if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                parentFragmentManager.beginTransaction()
                    .replace(R.id.sideDetail, ListDetailFragment.newInstance(article, "")).commit()
            } else {
                parentFragmentManager.beginTransaction()
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(param1: String, param2: String) = ListArtisFragment().apply {
